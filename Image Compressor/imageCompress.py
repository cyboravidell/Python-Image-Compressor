...
def main():
    try:
        print("Enter the file name you want to compress")
        image_path = input()
        print("Enter the optimal range You want to compress the Image")
        K = int(input())
    ...
    # the number of colors in the image is K
    ...
    compressed_image.save(f'compress_image\\Compressed {image_path}')
